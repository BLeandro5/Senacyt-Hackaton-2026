...
import { Check, ChevronRight, CirclePlus, ShieldCheck, Pencil, Sparkles, Trash2 } from 'lucide-react'
        ...
        <div className="flow-layout">
          ...
          <div className="flow-content">
            ...
            <FollowUp
              ...
              language={observation.analysis?.detected_language === 'en' || observation.analysis?.detected_language === 'pt' ? observation.analysis.detected_language : detectUserLanguage(observation.observation)}
              observationId={
                observation.id ||
